...
* 🗡 [Edge function](https://github.com/brootaylor/brootaylor-v3/blob/main/netlify/edge-functions/aiAgents.js) to perform *(known)* Ai bot detection, suspicious path blocking, and applicable error page handling
